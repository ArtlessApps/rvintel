#!/usr/bin/env node
// RVshare ArkLaTex backfill — direct JSON:API (2026-06-06).
//
// Mirrors backfill_rvshare_sd.mjs exactly — only MARKET, LOCATION, and
// MAX_PAGES differ. Search anchored to Shreveport, LA metro.
//
// Usage:
//   node scripts/backfill_rvshare_arklatex.mjs
...
async function main() {
  ...
  console.log(`RVshare ArkLaTex backfill (direct API) started ${startedAt.toISOString()}`);
