...
const PLANS = [
  {
    ...
    price: "$9.99",
    subtitle: "Track 1 RV",
    features: ["All 35 US markets", "Daily price updates", "Rate trends & history", "1 RV in fleet tracker"],
  ...
  },
  {
    ...
    features: ["All 35 US markets", "Daily price updates", "Rate trends & history", "Up to 5 RVs in fleet", "Comp-sets (coming soon)"],
  ...
  },
  {
    ...
    features: ["All 35 US markets", "Daily price updates", "Rate trends & history", "Unlimited RVs in fleet", "Comp-sets (coming soon)", "Occupancy data (coming soon)"],
    missing: [],
    featured: false,
  },
];
